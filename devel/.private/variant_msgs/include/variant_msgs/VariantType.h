...
struct VariantType_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _md5_sum_type;
...
struct Printer< ::variant_msgs::VariantType_<ContainerAllocator> >
{
  ...
  {
    s << indent << "md5_sum: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.md5_sum);
    s << indent << "data_type: ";
