...
struct Test_
{
  ...
  _boolean_type boolean;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _builtin_string_type;
  ...
  _builtin_int_array_type builtin_int_array;
   ...
   typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _builtin_int_vector_type;
  ...
  _string_array_type string_array;
   ...
   typedef std::vector< ::std_msgs::String_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::std_msgs::String_<ContainerAllocator> >::other >  _string_vector_type;
...
struct Printer< ::variant_msgs::Test_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::variant_msgs::Test_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.builtin_string);
    s << indent << "string: ";
    s << std::endl;
