...
void rqt_multiplot::MultiplotWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MultiplotWidget *_t = static_cast<MultiplotWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rqt_multiplot::MultiplotWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rqt_multiplot__MultiplotWidget.data,
      qt_meta_data_rqt_multiplot__MultiplotWidget,  qt_static_metacall, nullptr, nullptr}
};
