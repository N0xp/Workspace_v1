...
if("TRUE" STREQUAL "TRUE")
  set(rqt_multiplot_SOURCE_PREFIX /home/pi/catkin_ws/src/rqt_multiplot_plugin)
  set(rqt_multiplot_DEVEL_PREFIX /home/pi/catkin_ws/devel/.private/rqt_multiplot)
  ...
  set(rqt_multiplot_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Samuel Bachmann <sbachmann@anybotics.com>, Philipp Leemann <pleemann@anybotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_multiplot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/rqt_multiplot_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel/.private/rqt_multiplot/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rqt_multiplot_EXPORTED_TARGETS ${${rqt_multiplot_dep}_EXPORTED_TARGETS})
endforeach()
