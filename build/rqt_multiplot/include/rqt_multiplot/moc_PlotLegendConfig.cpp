...
void rqt_multiplot::PlotLegendConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PlotLegendConfig *_t = static_cast<PlotLegendConfig *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rqt_multiplot::PlotLegendConfig::staticMetaObject = {
    { &Config::staticMetaObject, qt_meta_stringdata_rqt_multiplot__PlotLegendConfig.data,
      qt_meta_data_rqt_multiplot__PlotLegendConfig,  qt_static_metacall, nullptr, nullptr}
};
