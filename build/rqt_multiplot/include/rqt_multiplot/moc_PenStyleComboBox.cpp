...
void rqt_multiplot::PenStyleComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PenStyleComboBox *_t = static_cast<PenStyleComboBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rqt_multiplot::PenStyleComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_rqt_multiplot__PenStyleComboBox.data,
      qt_meta_data_rqt_multiplot__PenStyleComboBox,  qt_static_metacall, nullptr, nullptr}
};
