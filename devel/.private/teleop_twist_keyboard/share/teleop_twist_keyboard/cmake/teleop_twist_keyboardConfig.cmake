...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/pi/catkin_ws/src/telop_twist_keyboard)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/pi/catkin_ws/devel/.private/teleop_twist_keyboard)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/telop_twist_keyboard/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel/.private/teleop_twist_keyboard/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/noetic/lib)
