...
void rqt_multiplot::CurveAxisScaleConfigWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CurveAxisScaleConfigWidget *_t = static_cast<CurveAxisScaleConfigWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rqt_multiplot::CurveAxisScaleConfigWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rqt_multiplot__CurveAxisScaleConfigWidget.data,
      qt_meta_data_rqt_multiplot__CurveAxisScaleConfigWidget,  qt_static_metacall, nullptr, nullptr}
};
