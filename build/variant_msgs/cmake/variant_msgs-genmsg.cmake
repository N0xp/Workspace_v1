...
set(MSG_I_FLAGS "-Ivariant_msgs:/home/pi/catkin_ws/src/variant/variant_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
add_custom_target(_variant_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "variant_msgs" "/home/pi/catkin_ws/src/variant/variant_msgs/msg/VariantHeader.msg" ""
)

get_filename_component(_filename "/home/pi/catkin_ws/src/variant/variant_msgs/msg/VariantType.msg" NAME_WE)
add_custom_target(_variant_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "variant_msgs" "/home/pi/catkin_ws/src/variant/variant_msgs/msg/VariantType.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/variant_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/variant_msgs\")")
  # install generated code
  install(
