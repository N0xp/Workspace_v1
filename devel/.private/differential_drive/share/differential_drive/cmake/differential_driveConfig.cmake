...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/pi/catkin_ws/src/differential_drive)
  set(differential_drive_DEVEL_PREFIX /home/pi/catkin_ws/devel/.private/differential_drive)
  ...
  set(differential_drive_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/differential_drive/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel/.private/differential_drive/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/noetic/lib)
