...
void rqt_multiplot::MessageTopicComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MessageTopicComboBox *_t = static_cast<MessageTopicComboBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rqt_multiplot::MessageTopicComboBox::staticMetaObject = {
    { &MatchFilterComboBox::staticMetaObject, qt_meta_stringdata_rqt_multiplot__MessageTopicComboBox.data,
      qt_meta_data_rqt_multiplot__MessageTopicComboBox,  qt_static_metacall, nullptr, nullptr}
};
